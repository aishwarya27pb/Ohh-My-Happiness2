        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {categories.map((cat, i) => (
            <Link
              ...
              className="group flex flex-col items-center text-center p-5 rounded-3xl bg-[#FFF9EE] border-2 border-transparent hover:border-[#FFB449] hover:bg-[#FFE4C2] transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
            >
